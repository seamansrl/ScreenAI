...
namespace Horus
{
    public partial class Rostros : Form
    {
        ...
        public Rostros(String UUID = "", String Type = "")
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (e.ColumnIndex == 4 && e.RowIndex > -1)
                {
                    try
                    {
                        ...
                        ModifyRostro ModifyRostro_Window = new ModifyRostro(UUID, GlobalUUID);
                        ModifyRostro_Window.TopLevel = false;
                        ModifyRostro_Window.Dock = DockStyle.Fill;

                        SubPanel.Controls.Add(ModifyRostro_Window);

                        ModifyRostro_Window.Show();

                        ModifyRostro_Window.FormClosed += new FormClosedEventHandler(SubPanel_unload);
                    }
                    catch { }
                }
            }
        ...
        private void Button2_Click(object sender, EventArgs e) 
        {
            try {
                ...
                AddRostro AddRostro_Window = new AddRostro(GlobalUUID);
                AddRostro_Window.TopLevel = false;
                AddRostro_Window.Dock = DockStyle.Fill;

                SubPanel.Controls.Add(AddRostro_Window);

                AddRostro_Window.Show();

                AddRostro_Window.FormClosed += new FormClosedEventHandler(SubPanel_unload);
