...
namespace Horus
{
    public partial class ImageID : Form
    {
        ...
        public ImageID(String UUID = "", String Type = "")
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (e.ColumnIndex == 2 && e.RowIndex > -1)
                {
                    try
                    {
                        ...
                        ImageUpload ImageUpload_Window = new ImageUpload(UUID);
                        ImageUpload_Window.TopLevel = false;
                        ImageUpload_Window.Dock = DockStyle.Fill;

                        SubPanel.Controls.Add(ImageUpload_Window);

                        ImageUpload_Window.Show();

                        ImageUpload_Window.FormClosed += new FormClosedEventHandler(SubPanel_unload);
                    }
                    catch { }
                }
